...
<div class="container">
    ...
    <center><h1>SOLICITUD DE MANTENIMIENTO (BUSQUE EL MOTORIZADO)</h1></center>
    <center><h1>ENDE SERVICIOS Y CONSTRUCCIONES S.A. ORURO</h1></center>
    ...
    <div class="widget-content">
                ...
                <thead>
                    ...
                    @foreach ($vehicles as $record)
                        ...
                        <td><center>
                            <!--<a href="/record/recordPDF/{{$record->id}}" target="_blank" class="btn4" title="Imprimir Historial"><i class="fa fa-print"></i></a>-->
                            <a href="/demand/create/{{$record->id}}" class="btn1" title="Agregar Solicitud"><i class="fa fa-add"></i></a>
