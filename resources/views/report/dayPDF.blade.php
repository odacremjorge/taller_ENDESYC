...
<img class="foto1" src="{{public_path('images/ende.jpg')}}" width="200" loading="lazy" >
    <div class="foto2">
            ...
            <h4><center> FECHA: {{$date_report}}</center></h4>
    ...
    <center><h5>INFORME DIARIO</h5></center>
    <br>
    @if ($condition_report == "Todos")
    <h5>Informe de Trabajos Talleres Regional Oruro:</h5> 
    @else
    <h5>Informe de Trabajos Talleres Regional Oruro ({{$condition_report}}):</h5> 
    @endif
    <table>
        <thead>
            <tr>
