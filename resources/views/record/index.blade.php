...
<div class="container">
    ...
    <center><h1>HISTORIAL DEL PARQUE AUTOMOTRIZ ATENDIDO POR EL TALLER DE</h1></center>
                ...
                <thead>
                    ...
                    @foreach ($vehicles as $record)
                        ...
                        <td><center>
                            ...
                            <a href="/record/create/{{$record->id}}" class="btn1" title="Agregar"><i class="fa fa-add"></i></a>
